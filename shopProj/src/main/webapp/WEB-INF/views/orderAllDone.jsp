...
<link rel="stylesheet" href='<c:url value="resources/css/orderAllDone.css"/>'>
<script src="<c:url value="resources/js/jquery-3.3.1.js"/>"></script>
<script src="<c:url value="resources/js/orderAllDone.js"/>"></script>
		...
		<tr>
			<td>
				<table>
					...
					<c:forEach var="order" items="${orderAllDone }">	
					<c:set var="totalPrice" value="${order.gPrice * order.gAmount + totalPrice }"/>		
					<tr>
						<td>
